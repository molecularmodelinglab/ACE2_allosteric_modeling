...
class Model:
    ...
    def __init__(self, task, descriptor_function, batch_size = None, normalize = False, descriptor_handler = None, y_randomize = False):
...
class RF(Model):
    ...
    def __init__(self, task, descriptor_function, descriptor_handler = None, batch_size = None, normalize =
        ...
        super().__init__(task = task, descriptor_function = descriptor_function, descriptor_handler = descriptor_handler, batch_size = batch_size, normalize = normalize, y_randomize = y_randomize)
...
class GradientBoosting(Model):
    ...
    def __init__(self, task, descriptor_function, descriptor_handler = None, batch_size = None, normalize = False, y_randomize = False, **kwargs):
...
class NeuralNetwork(Model):
    ...
    def __init__(self, task, descriptor_function, descriptor_handler = None, batch_size = None, normalize = False, y_randomize = False, verbose = False, **kwargs):

        super().__init__(task, descriptor_function = descriptor_function,
...
class MUDRA(Model):
    ...
    def predict(self, mols):
        ...
        pred, min_distances, min_indices = self.model.predict(test_x)
